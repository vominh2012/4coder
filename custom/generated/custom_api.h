...
#define custom_get_languages_sig() TSLanguageData* custom_get_languages(Application_Links* app)
...
#define custom_draw_line_sig() void custom_draw_line(Application_Links* app, Vec2_f32 a, Vec2_f32 b, f32 roundness, f32 thickness, ARGB_Color color)
...
typedef TSLanguageData* custom_get_languages_type(Application_Links* app);
...
typedef void custom_draw_line_type(Application_Links* app, Vec2_f32 a, Vec2_f32 b, f32 roundness, f32 thickness, ARGB_Color color);
...
struct API_VTable_custom{
    ...
    custom_get_languages_type *get_languages;
    ...
    custom_draw_line_type *draw_line;
...
internal TSLanguageData* get_languages(Application_Links* app);
...
global custom_get_languages_type *get_languages = 0;
...
global custom_draw_line_type *draw_line = 0;
