...
api(custom) function TSLanguageData* get_languages(Application_Links* app);
...
api(custom) function void draw_line(Application_Links* app, Vec2_f32 a, Vec2_f32 b, f32 roundness, f32 thickness, ARGB_Color color);
