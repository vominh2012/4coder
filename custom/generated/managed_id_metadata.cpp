...
buffer_auto_indent_setting = managed_id_declare(app, string_u8_litexpr("attachment"), string_u8_litexpr("buffer_auto_indent_setting"));
buffer_virtual_whilespace_setting = managed_id_declare(app, string_u8_litexpr("attachment"), string_u8_litexpr("buffer_virtual_whilespace_setting"));
buffer_lex_task = managed_id_declare(app, string_u8_litexpr("attachment"), string_u8_litexpr("buffer_lex_task"));
buffer_tree_sitter_task = managed_id_declare(app, string_u8_litexpr("attachment"), string_u8_litexpr("buffer_tree_sitter_task"));
...
tree_sitter_attachment_tsdata = managed_id_declare(app, string_u8_litexpr("attachment"), string_u8_litexpr("tree_sitter_attachment_tsdata"));
}
