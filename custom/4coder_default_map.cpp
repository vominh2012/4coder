...
setup_default_mapping(Mapping *mapping, i64 global_id, i64 file_id, i64 code_id){
    ...
    Bind(change_active_panel_backwards, KeyCode_W, KeyCode_Control, KeyCode_Shift);
    Bind(interactive_new,               KeyCode_N, KeyCode_Control);
    Bind(interactive_open_or_new,       KeyCode_O, KeyCode_Control);
    Bind(open_in_other,                 KeyCode_O, KeyCode_Shift, KeyCode_Control);
    Bind(open_matching_file_cpp,        KeyCode_C, KeyCode_Alt);
    Bind(open_matching_file_cpp_other,        KeyCode_C, KeyCode_Alt, KeyCode_Shift);
    Bind(open_folder_explorer,          KeyCode_O, KeyCode_Control, KeyCode_Alt);
    Bind(interactive_kill_buffer,       KeyCode_K, KeyCode_Control);
    Bind(interactive_switch_buffer,     KeyCode_B, KeyCode_Control);
    Bind(interactive_switch_other_window_buffer,   KeyCode_B, KeyCode_Control, KeyCode_Shift);
    Bind(build_in_build_panel,          KeyCode_M, KeyCode_Alt);
    Bind(list_all_functions_current_buffer_lister, KeyCode_J, KeyCode_Control);
    Bind(list_all_functions_all_buffers_lister, KeyCode_J, KeyCode_Control, KeyCode_Shift);
    Bind(jump_to_definition_at_cursor, KeyCode_F11);
